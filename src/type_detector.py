...
TYPE1_RULES = [
    # 听音类（听力题）
    {"type": "听音选择", "keywords": ["听一听", "听录音", "听对话", "听短文", "听音", "听句子", "听单词",
                                      "listen", "听下面", "听材料", "听问题"],
     "audio": True, "priority": 90},
    {"type": "听音判断", "keywords": ["判断", "对错", "相符", "一致", "√", "×", "正确打", "打勾"],
     "audio": True, "priority": 88},
    {"type": "听音排序", "keywords": ["排序", "排列", "按顺序", "排成", "给下列", "按听到的顺序"],
     "audio": True, "priority": 85},
    {"type": "听音匹配", "keywords": ["听录音匹配", "听一听匹配", "听音匹配", "听录音连线", "听音连线"],
